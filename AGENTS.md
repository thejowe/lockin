...
Las comprobaciones en dispositivo (lo que antes se hacía «a mano» o «en el Expo Go del usuario») las hace el agente `comprobador` (`.claude/agents/comprobador.md`) en el emulador Android local. Ver `docs/plan/PLAN.md` → «Comprobaciones en dispositivo».
